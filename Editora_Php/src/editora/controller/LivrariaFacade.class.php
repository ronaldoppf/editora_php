...
class LivrariaFacade {
	...
	private function __construct() {
		$this->service = new LivrariaService ( null );
	}
	 ...
	 * LivrariaFacade.
	 *
	 * @return LivrariaFacade instance - Uma instancia da própria Classe.
	 */
	public static function getInstance() {
		if (self::$instance == null) {
			self::$instance = new LivrariaFacade ();
		}
	...
	public function inserir($cpf, $nome, $estado, $cidade, $logradouro, $cep) {
		try {
			$po = new LivrariaPO ( null, $cpf, $nome, $estado, $cidade, $logradouro, $cep );
	 ...
	 * Negocio(M).
	 */
	public function alterar($codlivraria, $cpf, $nome, $estado, $cidade, $logradouro, $cep) {
		try {
			$po = new LivrariaPO ( $codlivraria, $cpf, $nome, $estado, $cidade, $logradouro, $cep );
	 ...
	 * @return the bare_field_name
	 */
	public function buscarPorCodigo($codlivraria) {
		try {
			$po = new LivrariaPO ( $codlivraria );
	 ...
	 * @return the bare_field_name
	 */
	public function excluir($codlivraria) {
		$po = new LivrariaPO ( $codlivraria );
