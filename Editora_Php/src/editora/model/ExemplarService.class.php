...
class ExemplarService {
	 ...
	 */
	public function inserir(ExemplarPO $po) {
		/**
	 ...
	 * de persitъncia(DAO).
	 */
	public function alterar(ExemplarPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
	 ...
	 */
	public function buscarCodigo(ExemplarPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
	 ...
	 */
	public function excluir(ExemplarPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
