...
class LivrariaService {
	 ...
	 */
	public function inserir(LivrariaPO $po) {
		/**
	 ...
	 * de persitъncia(DAO).
	 */
	public function alterar(LivrariaPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
	 ...
	 */
	public function buscarCodigo(LivrariaPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
	 ...
	 */
	public function excluir(LivrariaPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
