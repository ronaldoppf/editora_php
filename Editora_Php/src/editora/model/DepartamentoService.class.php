...
class DepartamentoService {
	 ...
	 */
	public function inserir(DepartamentoPO $po) {
		/**
	 ...
	 * de persitъncia(DAO).
	 */
	public function alterar(DepartamentoPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
	 ...
	 */
	public function buscarCodigo(DepartamentoPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
	 ...
	 */
	public function excluir(DepartamentoPO $po) {
		/**
		 * Criando um Bloco de Transaчуo
		 */
		try {
